...
| [`docs/usage-service-manager.md`](./docs/usage-service-manager.md) | Admin Usage tab — columns, post count cache, cost attribution, collapsible service banner, bugs fixed April 2026 |
